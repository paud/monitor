...
//这个地方加extern "C"可以使得cpp文件直接include，和c一样用
//而不必在cpp中把#include语句用extern "C"{ ... }包起来
#ifdef __cplusplus
extern "C" {
#endif
...
typedef UINT32 uint;
typedef UINT16 word,wchar,*pwchar;
typedef UINT8 byte,*pchar;
...
typedef struct stTWinAPICall {
  ...
  pointer(*CallBackGoThroughHandles)(pointer obj, ...);
  pointer(*free)(pointer obj, ...);
...
//这个地方对应最上面的extern "C"可以使得cpp文件直接include，和c一样用
#ifdef __cplusplus
}
#endif